...
map.getView().fit([-19111.914397, 6704619.120951, -1438.906371, 6713994.850544], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Location of Housing Provider Head Offices</h2>';
        return titleElement;
    })(),
